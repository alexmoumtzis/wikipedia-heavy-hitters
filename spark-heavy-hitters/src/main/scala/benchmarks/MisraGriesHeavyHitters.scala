...
object MisraGriesHeavyHitters {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val defaultOutputPath    = common.ProjectPaths.uri("results/mg_topk")
    ...
    val benchmarkReportPath  = common.ProjectPaths.path("results/mg_benchmark_report.txt")
    val benchmarkMetricsPath = common.ProjectPaths.path("results/mg_benchmark_metrics.csv")
